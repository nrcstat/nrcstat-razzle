...
export default function (widgetParams) {
  ...
  const title = t(`RefugeeReport${periodYear + 1}.RefugeesTo.NewRefugeesToCountryPerWorldZone.Heading`)

  const footerAnnotations = t(`RefugeeReport${periodYear + 1}.RefugeesTo.NewRefugeesToCountryPerWorldZone.TableFooterText`)
