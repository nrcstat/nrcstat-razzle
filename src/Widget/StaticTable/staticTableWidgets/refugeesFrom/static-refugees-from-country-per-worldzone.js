...
export default function (widgetParams) {
  ...
  const title = t(`RefugeeReport${periodYear + 1}.RefugeesFrom.RefugeesFromCountryPerWorldZone.Heading`)

  const footerAnnotations = t(`RefugeeReport${periodYear + 1}.RefugeesFrom.RefugeesFromCountryPerWorldZone.TableFooterText`)
