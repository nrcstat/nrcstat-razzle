...
export default function (widgetParams) {
  ...
  const title = t(`RefugeeReport${periodYear + 1}.IDP.NewIdpsPerWorldZone.Heading`)

  const footerAnnotations = t(`RefugeeReport${periodYear + 1}.IDP.NewIdpsPerWorldZone.TableFooterText`)
    .replace('\n', '<br /><br />')
