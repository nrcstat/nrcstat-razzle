...
const title = `Land hvor flest mennesker er drevet på flukt <sup class="nrcstat-widget-tooltip" title="Omfatter både internt fordrevne i landet og mennesker som har flyktet fra landet ved inngangen til 2017.">1)</sup>`

const footerAnnotations = [
  "<sup>1)</sup> Omfatter både internt fordrevne i landet og mennesker som har flyktet fra landet ved inngangen til 2017.",
